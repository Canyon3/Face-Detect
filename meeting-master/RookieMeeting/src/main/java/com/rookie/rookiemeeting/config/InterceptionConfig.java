...
public class InterceptionConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(jwtInterceptor())
                ...
                .excludePathPatterns("/bookings/exports/{meetingid}","/employee/login", "/employee/register", "/department/all", "/faceLogin", "/download", "/swagger-resources/**", "/webjars/**", "/v2/**", "/swagger-ui.html/**", "/api", "/api-docs", "/api-docs/**")
